...
// DEFINES RELATED WITH MQTT AND WIFI 
...
#define LED_GPIO2 26   // CONFIGURAR BUTTON. IT'S TO ADD NETWORK AND WIFI
...
//uint8_t global_ssid[32]={"Guille2g"};
//uint8_t global_password[64]={"Guille2360"};
...
// This function print dht values on monitor serial 
void imprimir_Dht(){
...
//This function check the value of CONFIGURAR to know if go to AP_MODE configure  or STA_MODE
